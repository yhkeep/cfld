...
# cfg.TEST.MICRO_BATCH_SIZE = 6
# cfg.ACCELERATE.MIXED_PRECISION = "fp16"
def build_test_loader(cfg):
    ...
    test_data = Subset(test_data, range(num_samples))
...
def main(cfg):
    ...
    save_dir = os.path.join(run_dir, "log_test_images")
